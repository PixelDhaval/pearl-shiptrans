            ...
            <div class="col-xl-8 col-lg-7">
                <div class="insurance-details__right">
                    <div class="insurance-details__img-1 mb-3">
                        <img src="{{ asset('assets/images/resources/freight-1.jpg') }}" alt="">
                    </div>
                    <p class="insurance-details__text-1">At Pearl Shiptrans Pvt Ltd, we provide end-to-end freight forwarding solutions, ensuring smooth, secure, and cost-effective cargo transportation across the globe. Our expertise in multimodal logistics—ocean, air, rail, and road—allows us to offer flexible and customized solutions tailored to your supply chain needs.</p>
                    <p class="insurance-details__text-2">Seamless Global Logistics & Cargo Movement</p>
                    <p class="insurance-details__text-3">With a strong network of international shipping partners, customs authorities, and logistics providers, we ensure timely deliveries, optimized costs, and hassle-free documentation, making global trade easier for businesses of all sizes.</p>
                    <h2 class="section-title-four__title">Why Choose Our Freight Forwarding Services?</h2>
                    <div class="insurance-details__opportunities">
                        <div class="insurance-details__opportunities-img">
                            <img src="{{ asset('assets/images/resources/freight-2.jpg') }}"
                                alt="">

                        </div>
                        <div class="insurance-details__opportunities-points-box">
                            <h3 class="insurance-details__opportunities-points-title">Comprehensive Logistics & Transport Solutions</h3>
                            <ul class="about-seven__points list-unstyled">
                                <li>
                                    ...
                                    <div class="text">
                                        <p>Seamless coordination for ocean, air, rail, and road freight</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                                    ...
                                    <div class="text">
                                        <p>Cost-effective and time-sensitive shipment planning
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="text">
                                        <p>Cargo consolidation and deconsolidation for efficiency
                                        </p>
                                    </div>
                            </ul>
                        </div>
                    ...
                    <ul class="insurance-details__points list-unstyled">
                        <li>
                            <div class="insurance-details__points-left">
                                ...
                                <h3 class="insurance-details__points-title">Regulatory Compliance Management</h3>
                            </div>
                            <div class="insurance-details__points-right">
                                <p>Customs clearance and regulatory compliance management</p>
                            </div>
                        </li>
                        <li>
                            <div class="insurance-details__points-left">
                                ...
                                <h3 class="insurance-details__points-title">Live Shipment Tracking</h3>
                            </div>
                            <div class="insurance-details__points-right">
                                <p>Real-time shipment tracking and status updates</p>
                            </div>
                        </li>
                        <li>
                            <div class="insurance-details__points-left">
                                ...
                                <h3 class="insurance-details__points-title">Personalized Logistics Support</h3>
                            </div>
                            <div class="insurance-details__points-right">
                                <p>Dedicated support for personalized logistics solutions</p>
                            </div>
                        </li>
                    </ul>
                    <p class="insurance-details__text-2">With Pearl Shiptrans, move your cargo efficiently, securely, and on time—across borders and beyond!</p>
                </div>
            </div>
        </div>
    </div>
