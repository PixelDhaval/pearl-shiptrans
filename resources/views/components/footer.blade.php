<footer class="site-footer">
            ...
            <div class="container">
                <div class="site-footer__top">
                    <div class="row">
                        <div class="col-xl-9 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget__about">
                                <div class="footer-widget__logo">
                                    <a href="{{ route('index') }}"><img src="{{ asset('assets/images/resources/footer-logo.png') }}" alt="" style="height: 80px;"></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget__column footer-widget__contact clearfix">
                                ...
                                <ul class="footer-widget__contact-list list-unstyled clearfix mb-3">
                                    <li>
                                        <div class="icon">
                                ...
                                <div class="footer-widget__open-hour">
                                    ...
                                    <h3 class="footer-widget__open-hour-text">Mon – Sat: 8:00 am to 6:00 pm<br> Sunday:
                                        Closed</h3>
                                </div>
                            </div>
                        </div>
