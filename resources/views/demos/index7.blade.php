            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="services-seven__single">
                        <h3 class="services-seven__title"><a href="{{ route('lifeInsurance') }}">Life Insurance</a></h3>
                        ...
                        <div class="services-seven__hover-box">
                            ...
                            <h3 class="services-seven__hover-title"><a href="{{ route('lifeInsurance') }}">life insurance</a>
                            </h3>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="services-seven__single">
                        <h3 class="services-seven__title"><a href="{{ route('homeInsurance') }}">Fire Insurance</a></h3>
                        <p class="services-seven__text">Lorem ipsum dolor amet, consectetur <br>
                            adipiscing elit, sed eiusmod tempor <br>
                            incididunt labore..</p>
                        ...
                        <div class="services-seven__hover-box">
                            ...
                            <h3 class="services-seven__hover-title"><a href="{{ route('fireInsurance') }}">Fire insurance</a>
                            </h3>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="services-seven__single">
                        <h3 class="services-seven__title"><a href="{{ route('lifeInsurance') }}">Health Insurance</a></h3>
                        <p class="services-seven__text">Lorem ipsum dolor amet, consectetur <br>
                            adipiscing elit, sed eiusmod tempor <br>
                            incididunt labore..</p>
                        <a href="{{ route('lifeInsurance') }}" class="services-seven__btn thm-btn-four">Details<span class="fas fa-arrow-right"></span></a>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="services-seven__single">
                        <h3 class="services-seven__title"><a href="{{ route('lifeInsurance') }}">Home Insurance</a></h3>
                        <p class="services-seven__text">Lorem ipsum dolor amet, consectetur <br>
                            adipiscing elit, sed eiusmod tempor <br>
                            incididunt labore..</p>
                        <a href="{{ route('lifeInsurance') }}" class="services-seven__btn thm-btn-four">Details<span class="fas fa-arrow-right"></span></a>
                        ...
                        <div class="services-seven__hover-box">
                            ...
                            <h3 class="services-seven__hover-title"><a href="{{ route('homeInsurance') }}">Home Insurance</a>
                            </h3>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                    <div class="services-seven__single">
                        <h3 class="services-seven__title"><a href="{{ route('travelInsurance') }}">Travel Insurance</a></h3>
                        <p class="services-seven__text">Lorem ipsum dolor amet, consectetur <br>
                            adipiscing elit, sed eiusmod tempor <br>
                            incididunt labore..</p>
                        <a href="{{ route('lifeInsurance') }}" class="services-seven__btn thm-btn-four">Details<span class="fas fa-arrow-right"></span></a>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                    <div class="services-seven__single">
                        <h3 class="services-seven__title"><a href="{{ route('travelInsurance') }}">Business Insurance</a>
                        </h3>
                        <p class="services-seven__text">Lorem ipsum dolor amet, consectetur <br>
                            adipiscing elit, sed eiusmod tempor <br>
                            incididunt labore..</p>
