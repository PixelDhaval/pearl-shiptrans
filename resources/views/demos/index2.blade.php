                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('carInsurance') }}">Car insurance</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('lifeInsurance') }}">Life insurance</a></h3>
                                <p class="services-two__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    rutrum metus et elit.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('homeInsurance') }}">Home insurance</a></h3>
                                <p class="services-two__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    rutrum metus et elit.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('healthInsurance') }}">Health insurance</a>
                                </h3>
                                <p class="services-two__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    rutrum metus et elit.</p>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('businessInsurance') }}">Business insurance</a>
                                </h3>
                                <p class="services-two__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    rutrum metus et elit.</p>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('fireInsurance') }}">Fire insurance</a></h3>
                                <p class="services-two__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    rutrum metus et elit.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="700ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('marriageInsurance') }}">Marriage insurance</a>
                                </h3>
                                <p class="services-two__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    rutrum metus et elit.</p>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="800ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="{{ route('travelInsurance') }}">Travel insurance</a>
                                </h3>
                                <p class="services-two__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    rutrum metus et elit.</p>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-two__single">
                            ...
                            <div class="news-two__content">
                                <h3 class="news-two__title"><a href="{{ route('newsDetails') }}">Which allows you to pay down
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="news-two__single">
                            ...
                            <div class="news-two__content">
                                <h3 class="news-two__title"><a href="{{ route('newsDetails') }}">Leverage agile frameworks to
                                        provide</a></h3>
                                <div class="news-two__client">
                                    <div class="news-two__client-img">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="news-two__single">
                            ...
                            <div class="news-two__content">
                                <h3 class="news-two__title"><a href="{{ route('newsDetails') }}">Bring to the table win-win
